...
public class ServiceParcela implements  IServiceParcela{
    ...
    public Parcela update(int id, Parcela parcela) {
        ...
        if(buscada!=null){
            ...
            buscada.setImagen(parcela.getImagen());
    ...
    private void comprobarEstadoParcelas(List<Parcela> parcelas, List<Estancia> estancias) {
        ...
        for(Parcela parcela : parcelas){
            ...
            if(parcela.getEstado_parcela() != EstadoParcela.MANTENIMIENTO && parcela.getEstado_parcela() != EstadoParcela.INTERESADO && parcela.getEstado_parcela() != nuevoEstado){
