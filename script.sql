...
insert into clientes (fecha_nacimiento, nombre, apellidos, email, password, direccion, c_postal, dni, telefono) values
                                                                                                                    ('1990-05-14', 'Carlos', 'Gómez Ruiz', 'carlos@email.com', '1234', 'Calle Mayor 12', '39001', '12345678A', '600123456'),
                                                                                                                    ('1985-11-02', 'Laura', 'Fernández Díaz', 'laura@email.com', '1234', 'Av. Cantabria 45', '39005', '87654321B', '611987654'),
                                                                                                                    ('2000-08-22', 'Miguel', 'Inglés Pérez', 'miguel@email.com', '1234', 'Calle Montaña 7', '39300', '11223344C', '622334455');

insert into empleado (activo, nombre, apellidos, dni, telefono, puesto) values
                                                                            (1, 'Ana', 'Martínez López', '99887766D', '633445566', 'ADMINISTRADOR'),
                                                                            (1, 'Javier', 'Santos Pérez', '88776655E', '644556677', 'RECEPCIONISTA'),
                                                                            (1, 'Lucía', 'Ortega Ramos', '77665544F', '655667788', 'CAMPO');
...
insert into clientes_estancia values
                                  (1,1),
                                  (2,2),
                                  (3,3);
...
insert into estancia_servicios values
                                   (1,1),
                                   (1,2),
                                   (2,2),
                                   (3,3);
